...
2026-08-31兼容升级：产品Schema现为v2，v1快照保留。下述普通chat容量由
`docs/deep-chat-contract.md`替代：enabled/high、32768token、180秒模型/190秒页面、16000字输入、
64000字回答、50轮；最近最多12对问答且正文≤120000字，累计内容门禁400000字。
响应新增context_trimmed；非空预算截断答案保留并提示。下述consult专业咨询和工单规则不变。
